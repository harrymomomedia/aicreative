...
def word_trim(n):
    ...
    tx_path = DISSECT / f"ca_jdc_m6_clip{n}" / "transcript.json"
...
if __name__ == "__main__":
    ...
    def vc_clip(n):
        ...
        audio_in = f"/tmp/ca_m6_clip{n}_in.mp3"
