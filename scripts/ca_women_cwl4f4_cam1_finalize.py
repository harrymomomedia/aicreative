"""
CA Women CWL4_F4 cam1 finalize:
  word-aware trim → voice clone (clip1) → voice_changer → loudnorm → stitch → crop
Persona: CWL4_F4_v1 — Latina 44, Nicaraguan, San Diego boardwalk
"""
...
INTENDED = {
    1: "you think it doesnt count because you didnt scream because you didnt fight",
    2: "let me tell you something in a california womens prison you couldnt fight he had the keys he had the writeups",
    3: "he decided if you ate if you got moved if you ever saw daylight",
    4: "going still wasnt saying yes it was the only way to survive him",
    5: "what a staff member did to you behind those walls was still abuse theres a lawsuit now for exactly this",
    6: "women who never fought back may qualify for significant potential compensation",
    7: "its confidential it costs nothing just see if youre one of them tap below",
}
...
def word_trim(n):
    ...
    tx_path = DISSECT / f"ca_women_cwl4f4_cam1_clip{n}" / "transcript.json"
...
if __name__ == "__main__":
    ...
    def vc_clip(n):
        ...
        audio_in = f"/tmp/cwl4f4_clip{n}_in.mp3"
