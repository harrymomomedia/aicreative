...
from scripts.chowchilla_w05_ads import SCRIPTS, out_dir
...
def trim(ad, i, lead=0.05, tail=0.06, leadpad=0.15):
...
VOICE_ID_CACHE = ROOT / "outputs/chowchilla_white_personas/w05_voice_id.txt"
...
def get_voice_id():
    ...
    vid = clone_voice("w05_chowchilla", [str(concat)])
...
def loudnorm(ad, i, src_suffix="trimmed"):
    ...
    if not out.exists():
        ffmpeg(["-i", str(src), "-af", "loudnorm=I=-16:TP=-1.5:LRA=11",
