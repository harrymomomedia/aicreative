...
INTENDED = {
    1: "You saw this and kept scrolling maybe you thought it wasnt for you",
    2: "Maybe you thought it was too late or nobody would believe you or it would blow up your life",
    3: "None of that is true a guard or staff abused you as a kid in Illinois juvie",
    4: "Significant compensation is still open Illinois is not going to announce this on the news",
    5: "They are banking on survivors not coming forward",
    6: "Every person who stays quiet is a person they dont have to pay thats the math",
    7: "The deadline hasnt passed yet completely private nobody in your life finds out free to check",
    8: "Two minutes you fill out one form and a legal team tells you if you qualify",
    9: "No cost unless they win go look thats it tap below",
}
...
def word_trim(n):
    ...
    tx_path = DISSECT / f"il_jdc_m1_clip{n}" / "transcript.json"
...
if __name__ == "__main__":
    ...
    def vc_clip(n):
        ...
        audio_in = f"/tmp/m1_clip{n}_in.mp3"
