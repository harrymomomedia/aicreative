"""
CA Women CWL3_F3 cam1 finalize:
...
INTENDED = {
    1: "california needed your silence not your cooperation your silence they got it for decades",
    2: "and now a court has decided that silence has a dollar amount attached to it",
    3: "women sexually abused inside california womens prisons may qualify for significant potential compensation",
    4: "not because of what they can prove because of what the state already knows happened",
    5: "no court no public record private and confidential",
    6: "tap below it takes 60 seconds to fill out the form collect what they owe you",
}
...
def word_trim(n):
    ...
    tx_path = DISSECT / f"ca_women_cwl3f3_cam1_clip{n}" / "transcript.json"
...
if __name__ == "__main__":
    ...
    def vc_clip(n):
        ...
        audio_in = f"/tmp/cwl3f3_clip{n}_in.mp3"
