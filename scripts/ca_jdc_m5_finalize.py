...
INTENDED = {
    1: "You were a kid maybe twelve maybe fourteen locked up for something small",
    2: "And someone who was supposed to be in charge of you used that to sexually abuse you that was never supposed to happen",
    3: "And when it was over you didn't call it what it was",
    4: "Because you were in a place where calling it what it was cost you more time",
    5: "But it was abuse what they did to you as a child in a California juvenile facility was abuse",
    6: "And right now California is being sued hundreds of survivors have come forward the state is settling these cases",
    7: "You may be owed significant potential compensation zero proof from back then zero police reports zero contact with anyone from that facility",
    8: "Private free one form sixty seconds tap below you were a kid you don't have to carry this the same way anymore",
}
...
def word_trim(n):
    ...
    tx_path = DISSECT / f"ca_jdc_m5_clip{n}" / "transcript.json"
    ...
    # find first intended word (handles leading filler)
...
if __name__ == "__main__":
    ...
    def vc_clip(n):
        ...
        audio_in = f"/tmp/ca_m5_clip{n}_in.mp3"
